...
```bash
cd /tmp && curl -fLO https://github.com/w87051809/cloudflared-web-zh-cn/releases/download/v2026.9.1-zh-cn.17/install.sh && curl -fLO https://github.com/w87051809/cloudflared-web-zh-cn/releases/download/v2026.9.1-zh-cn.17/install.sh.sha256 && sha256sum -c install.sh.sha256 && sh ./install.sh
```
...
docker buildx build \
  ...
  -t cloudflared-web-zh-cn:2026.9.1-zh-cn.17 .
```
