...
[![cloudflared](https://img.shields.io/badge/cloudflared-2026.9.1-2f73b8)](https://github.com/cloudflare/cloudflared/releases/tag/2026.9.1)
...
```bash
cd /tmp && curl -fLO https://github.com/w87051809/cloudflared-web-zh-cn/releases/download/v2026.9.1-zh-cn.18/install.sh && curl -fLO https://github.com/w87051809/cloudflared-web-zh-cn/releases/download/v2026.9.1-zh-cn.18/install.sh.sha256 && sha256sum -c install.sh.sha256 && sh ./install.sh
```
...
- cloudflared `2026.9.1` 使用经过 SHA-256 校验的官方标签源码和 Go `1.26.6` 构建，纳入官方安全修复。
...
docker buildx build \
  ...
  -t cloudflared-web-zh-cn:2026.9.1-zh-cn.18 .
```
